...
def getQV(obj, qvFile="10-qc/assembly.qv_cal.qv"):
    """
    ...
    qvFilePath = os.path.join(obj.verkkoDir, qvFile)
    ...
    try:
        ...
        # Assign column names
        qvTab.columns = ['asmName', 'nKmer_uniq_asm', 'nKmer_intersect', 'QV', 'ErrorRate']
